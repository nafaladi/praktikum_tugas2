          ...
          children: <Widget>[
            ...
            PageView(
              ...
              children: List.generate(
                recommendedModel.imageUrls.length,
                (int index) => Container(
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      fit: BoxFit.cover,
                      image: CachedNetworkImageProvider(
                          recommendedModel.imageUrls[index]),
                    ),
                  ),
                ),
              ),
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SmoothPageIndicator(
                      controller: _pageController,
                      count: recommendedModel.imageUrls.length,
                        ...
                        Container(
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              FittedBox(
                                child: Text(
                                  recommendedModel.ticketPrice.toString(),
                                  style: GoogleFonts.lato(
                                      fontWeight: FontWeight.w700,
                                      color: Colors.white),
                                ),
                        ...
                        Container(
                          ...
                          child: Align(
                            ...
                            child: Container(
                              ...
                              child: FittedBox(
                                child: Text(
                                  ' ${recommendedModel.openDays} \n ${recommendedModel.openTime}',
                                  style: GoogleFonts.lato(
                                      fontWeight: FontWeight.w700,
                                      color: Colors.white),
                                ),
